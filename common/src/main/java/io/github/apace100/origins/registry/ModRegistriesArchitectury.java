...
public class ModRegistriesArchitectury {
	...
	public static class CFEntity extends ArchitecturyWrappedRegistry.Wrapper<ConditionFactory<LivingEntity>, CFEntity> {
		public CFEntity(ConditionFactory<LivingEntity> value) {super(value);}
	}

	public static class CFItem extends ArchitecturyWrappedRegistry.Wrapper<ConditionFactory<ItemStack>, CFItem> {
		public CFItem(ConditionFactory<ItemStack> value) {super(value);}
	}

	public static class CFBlock extends ArchitecturyWrappedRegistry.Wrapper<ConditionFactory<CachedBlockPosition>, CFBlock> {
		public CFBlock(ConditionFactory<CachedBlockPosition> value) {super(value);}
	}

	public static class CFDamage extends ArchitecturyWrappedRegistry.Wrapper<ConditionFactory<Pair<DamageSource, Float>>, CFDamage> {
		public CFDamage(ConditionFactory<Pair<DamageSource, Float>> value) {super(value);}
	}

	public static class CFFluid extends ArchitecturyWrappedRegistry.Wrapper<ConditionFactory<FluidState>, CFFluid> {
		public CFFluid(ConditionFactory<FluidState> value) {super(value);}
	}

	public static class CFBiome extends ArchitecturyWrappedRegistry.Wrapper<ConditionFactory<Biome>, CFBiome> {
		public CFBiome(ConditionFactory<Biome> value) {super(value);}
	}

	public static class AFEntity extends ArchitecturyWrappedRegistry.Wrapper<ActionFactory<Entity>, AFEntity> {
		public AFEntity(ActionFactory<Entity> value) {super(value);}
	}

	public static class AFItem extends ArchitecturyWrappedRegistry.Wrapper<ActionFactory<ItemStack>, AFItem> {
		public AFItem(ActionFactory<ItemStack> value) {super(value);}
	}
	...
	public static class AFBlock extends ArchitecturyWrappedRegistry.Wrapper<ActionFactory<Triple<World, BlockPos, Direction>>, AFBlock> {
		public AFBlock(ActionFactory<Triple<World, BlockPos, Direction>> value) {super(value);}
	}
}
